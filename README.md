...
- [How to secure your Docker containers! (5 practical tips with example Dockerfiles! 🐳)](https://youtu.be/JE2PJbbpjsM)
- [DevOps Tutorial : Docker Secrets](https://youtu.be/OLSHSkSZLV8)
- [Build & Use Custom Docker images in your GitLab CI/CD pipeline](https://youtu.be/7I6tHw68DMQ)
- [DOCKERISER une application SYMFONY 🐳 🔥](https://youtu.be/KFWnB5hW6j8)
- [SYMFONY : Du DEV à la PROD (et DÉPLOIEMENT CONTINU avec GITHUB ACTION)](https://youtu.be/BxCu9McB6GU)
- [Docker Swarm Cheat Sheet](https://lzone.de/cheat-sheet/Docker%20Swarm)
